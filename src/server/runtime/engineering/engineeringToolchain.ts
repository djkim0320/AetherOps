...
export function embeddedEngineeringToolchainStatus(
  settings: EngineeringProgramSettings
): Record<EngineeringToolName, { ready: boolean; command?: string; source?: "embedded" | "custom"; error?: string }> {
  return {
...
): { ready: boolean; command?: string; source?: "embedded" | "custom"; error?: string } {
  try {

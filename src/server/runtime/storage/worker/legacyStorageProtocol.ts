...
export const PROJECT_MUTATION_METHODS = ["apply", "getReceipt", "listReceipts"] as const;

export type LegacyStorageTarget = "researchStore" | "projectStorage" | "settingsStore" | "projectMutations";
...
export interface LegacyStorageReady {
  type: "ready";
}
